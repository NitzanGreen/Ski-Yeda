...
lib.ssMetadata = [
		{name:"Ski_Yeda_atlas_", frames: [[1473,4204,148,144],[0,4204,1471,827],[1473,4350,148,144],[845,6025,136,140],[585,5855,258,310],[0,0,1623,4202],[585,6167,328,204],[0,5768,583,733],[561,6822,136,140],[1473,4496,148,144],[699,6822,136,140],[0,6874,148,144],[796,6373,136,140],[1473,4788,148,144],[796,6515,136,140],[915,6167,136,140],[420,6503,374,317],[1024,5033,323,317],[0,7020,148,144],[696,5577,369,276],[0,6503,418,369],[796,6657,136,140],[983,6025,136,140],[1473,4642,148,144],[1107,5751,136,140],[0,5033,694,733],[420,6822,139,293],[696,5033,326,344],[1067,5577,237,172],[845,5855,260,168],[150,6874,148,144],[585,6373,146,108],[1107,5893,147,107],[1349,5235,147,107],[696,5379,534,196],[1232,5352,200,200],[150,7020,148,144],[1349,5033,194,200]]}
];
...
(lib.apple01 = function() {
	this.spriteSheet = ss["Ski_Yeda_atlas_"];
	this.gotoAndStop(0);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(65.9,9.3);
...
(lib.play_again_btn = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(-0.3,-8.3);
...
}).prototype = getMCSymbolPrototype(lib.play_again_btn, new cjs.Rectangle(-31.4,-10.3,62.9,21), null);
...
(lib.pause_btn = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("השהייה", "bold 13px 'Arial'", "#006699");
	this.text.textAlign = "center";
	this.text.lineHeight = 17;
	this.text.lineWidth = 56;
	this.text.parent = this;
	this.text.setTransform(-1.7,-7.1);
...
}).prototype = getMCSymbolPrototype(lib.pause_btn, new cjs.Rectangle(-32.8,-9.1,62.9,21), null);


(lib.notmammal2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.owl01();
	this.instance.parent = this;
	this.instance.setTransform(-31,-32,0.457,0.457);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notmammal2, new cjs.Rectangle(-31,-32,62.2,64), null);


(lib.notmammal1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.fish01();
	this.instance.parent = this;
	this.instance.setTransform(-38,-39.1,0.559,0.559);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notmammal1, new cjs.Rectangle(-38,-39.1,76,78.3), null);


(lib.notmammal0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.butterfly01();
	this.instance.parent = this;
	this.instance.setTransform(-37.8,-39,0.557,0.557);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notmammal0, new cjs.Rectangle(-37.8,-39,75.8,78), null);


(lib.notfruit1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.eggplant01();
	this.instance.parent = this;
	this.instance.setTransform(-39,-38,0.528,0.528);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notfruit1, new cjs.Rectangle(-39,-38,78.1,76), null);


(lib.notfruit0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.cucumber01();
	this.instance.parent = this;
	this.instance.setTransform(-35,-34,0.473,0.473);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notfruit0, new cjs.Rectangle(-35,-34,70,68.1), null);


(lib.notfruit2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.carrot01();
	this.instance.parent = this;
	this.instance.setTransform(-37,-36,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.notfruit2, new cjs.Rectangle(-37,-36,74,72), null);
...
(lib.myBoard = function(mode,startPosition,loop) {
	...
	this.text_1.setTransform(20.5,-3.7);
	...
	this.text_3.setTransform(3.5,-75.8);
...
(lib.mammal5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.sheep01();
	this.instance.parent = this;
	this.instance.setTransform(-42,-43.2,0.618,0.618);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal5, new cjs.Rectangle(-42,-43.2,84,86.5), null);


(lib.mammal4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.pig01();
	this.instance.parent = this;
	this.instance.setTransform(-35.8,-36.9,0.528,0.528);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal4, new cjs.Rectangle(-35.8,-36.9,71.8,73.9), null);


(lib.mammal3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.fox01();
	this.instance.parent = this;
	this.instance.setTransform(-34,-35,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal3, new cjs.Rectangle(-34,-35,68,70), null);


(lib.mammal2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.dog01();
	this.instance.parent = this;
	this.instance.setTransform(-36,-37,0.529,0.529);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal2, new cjs.Rectangle(-36,-37,72,74.1), null);


(lib.mammal1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.cat01();
	this.instance.parent = this;
	this.instance.setTransform(-36,-37,0.529,0.529);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal1, new cjs.Rectangle(-36,-37,72,74.1), null);


(lib.mammal0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.bat01();
	this.instance.parent = this;
	this.instance.setTransform(-40.8,-42,0.601,0.601);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.mammal0, new cjs.Rectangle(-40.8,-42,81.7,84.1), null);
...
(lib.HIT_link = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(3.2,-9.7);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#009999").ss(1,1,1).p("ALGAAI2LAA");
	this.shape.setTransform(4.2,4.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.HIT_link, new cjs.Rectangle(-72,-11.7,150.4,26.5), null);
...
(lib.gate_1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("סיום", "bold 21px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
...
(lib.fruit3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.watermelon01();
	this.instance.parent = this;
	this.instance.setTransform(-37,-36,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit3, new cjs.Rectangle(-37,-36,74,72), null);


(lib.fruit0 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.strawberry01();
	this.instance.parent = this;
	this.instance.setTransform(-36,-35,0.486,0.486);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit0, new cjs.Rectangle(-36,-35,72,70.1), null);


(lib.fruit4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.raspberry01();
	this.instance.parent = this;
	this.instance.setTransform(-34.9,-33.9,0.472,0.472);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit4, new cjs.Rectangle(-34.9,-33.9,69.9,68), null);
...
(lib.fruit2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.lemon01();
	this.instance.parent = this;
	this.instance.setTransform(-32.9,-32,0.445,0.445);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit2, new cjs.Rectangle(-32.9,-32,65.8,64), null);


(lib.fruit5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.banana01();
	this.instance.parent = this;
	this.instance.setTransform(-30,-29.2,0.405,0.405);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit5, new cjs.Rectangle(-30,-29.2,60,58.4), null);
...
(lib.fruit1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.apple01();
	this.instance.parent = this;
	this.instance.setTransform(-37,-36,0.501,0.501);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.fruit1, new cjs.Rectangle(-37,-36,74.1,72.1), null);
...
(lib.end_btn = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 56;
	this.text.parent = this;
	this.text.setTransform(-0.3,-8.8);
...
}).prototype = getMCSymbolPrototype(lib.end_btn, new cjs.Rectangle(-31.4,-10.8,62.9,21), null);
...
(lib.continue_btn = function(mode,startPosition,loop) {
	...
	this.text.lineWidth = 56;
	this.text.parent = this;
	this.text.setTransform(-0.3,-8.4);
...
}).prototype = getMCSymbolPrototype(lib.continue_btn, new cjs.Rectangle(-31.4,-10.4,62.9,21), null);
...
(lib.about_btn = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("אודות", "bold 15px 'Arial'", "#006699");
	this.text.textAlign = "center";
...
(lib.results_pg = function(mode,startPosition,loop) {
	...
	this.your_time.lineWidth = 55;
	this.your_time.parent = this;
	this.your_time.setTransform(-164.7,-200.5);
	...
	this.your_grade.lineWidth = 55;
	this.your_grade.parent = this;
	this.your_grade.setTransform(136.4,-200.5);

	this.wrong_items = new cjs.Text("", "bold 18px 'Arial'", "#006699");
	...
	this.wrong_items.setTransform(-201.7,-65.1);

	this.correct_items = new cjs.Text("", "bold 18px 'Arial'", "#006699");
	...
	this.correct_items.setTransform(199.8,-65.1);
	...
	this.end_btn.setTransform(-163.2,241.2,1.19,1.19,0,0,0,0,-1);

	this.play_again_btn = new lib.play_again_btn();
	this.play_again_btn.name = "play_again_btn";
	this.play_again_btn.parent = this;
	this.play_again_btn.setTransform(107.6,241.2,1.19,1.19,0,0,0,0.1,-1);
	...
	this.text_1 = new cjs.Text(":הביצועים שלכם", "bold 18px 'Arial'", "#006699");
	this.text_1.textAlign = "center";
	...
	this.text_2 = new cjs.Text(":זמן", "bold 18px 'Arial'", "#006699");
	this.text_2.textAlign = "center";
	...
	this.text_3 = new cjs.Text(":ציון", "bold 18px 'Arial'", "#006699");
	this.text_3.textAlign = "center";
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.you_finished_game},{t:this.text_3},{t:this.text_2},{t:this.text_1},{t:this.text},{t:this.play_again_btn},{t:this.end_btn},{t:this.shape_1},{t:this.shape},{t:this.correct_items},{t:this.wrong_items},{t:this.your_grade},{t:this.your_time}]}).wait(1));
...
(lib.pause_pg = function(mode,startPosition,loop) {
	...
	this.text = new cjs.Text("המשחק בהשהייה", "bold 45px 'Arial'", "#006699");
	this.text.textAlign = "center";
	this.text.lineHeight = 52;
	this.text.lineWidth = 380;
	this.text.parent = this;
	this.text.setTransform(21.5,-47.7);
	...
	this.continue_btn_1.name = "continue_btn_1";
...
(lib.notMammals = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.text = new cjs.Text("נחש", "20px 'Arial'", "#0F4250");
	this.text.textAlign = "center";
	this.text.lineHeight = 24;
	this.text.lineWidth = 55;
	this.text.parent = this;
	this.text.setTransform(-58.3,77.5);

	this.text_1 = new cjs.Text("צפרדע", "20px 'Arial'", "#0F4250");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 24;
	this.text_1.lineWidth = 55;
	this.text_1.parent = this;
	this.text_1.setTransform(-361,3.5);

	this.instance = new lib.notmammal2();
	this.instance.parent = this;
	this.instance.setTransform(-158.1,11.1);

	this.instance_1 = new lib.notmammal1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-260,11.2);

	this.instance_2 = new lib.notmammal0();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-59,11.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.text_1},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.notMammals, new cjs.Rectangle(-390.3,-27.9,369.3,137.3), null);


(lib.notFruits = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.text = new cjs.Text("בצל", "20px 'Arial'", "#0F4250");
	this.text.textAlign = "center";
	this.text.lineHeight = 24;
	this.text.lineWidth = 55;
	this.text.parent = this;
	this.text.setTransform(-71.6,79);

	this.text_1 = new cjs.Text("קישוא", "20px 'Arial'", "#0F4250");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 24;
	this.text_1.lineWidth = 55;
	this.text_1.parent = this;
	this.text_1.setTransform(-350.5,2);

	this.instance = new lib.notfruit1();
	this.instance.parent = this;
	this.instance.setTransform(-252.3,14.1);

	this.instance_1 = new lib.notfruit0();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-152.4,14.1);

	this.instance_2 = new lib.notfruit2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-64,16.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance},{t:this.text_1},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.notFruits, new cjs.Rectangle(-379.9,-23.9,352.9,134.8), null);
...
(lib.forcomb = function(mode,startPosition,loop) {
	...
	this.mycb = new lib.an_ComboBox({'id': 'mycb', 'label':'', 'items':'dummy, dummy, items, 2, label, 0, , , data, 0, , , 3, בחר נושא, 0, פירות, 1, יונקים, 2', 'value':'0', 'disabled':false, 'visible':true, 'class':'ui-combobox'});
...
(lib.backgroundMC = function(mode,startPosition,loop) {
	...
	this.text = new cjs.Text("איך משחקים", "bold 15px 'Arial'", "#006699");
	this.text.textAlign = "center";
	this.text.lineHeight = 19;
	...
	this.text_1 = new cjs.Text("סקי-ידע", "bold 18px 'Arial'", "#006699");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 22;
...
(lib.about_pg = function(mode,startPosition,loop) {
	...
	this.text_2.parent = this;
	this.text_2.setTransform(-59.1,-75.5);

	this.text_3 = new cjs.Text(":אפיון ופיתוח", "bold 20px 'Arial'", "#006699");
	this.text_3.textAlign = "center";
	this.text_3.lineHeight = 24;
	this.text_3.lineWidth = 115;
	this.text_3.parent = this;
	this.text_3.setTransform(83.9,-75.5);

	this.text_4 = new cjs.Text("סקי-ידע", "bold 50px 'Arial'", "#006699");
	...
	this.text_5 = new cjs.Text("אודות", "bold 18px 'Arial'", "#006699");
	this.text_5.textAlign = "center";
	this.text_5.lineHeight = 22;
	this.text_5.lineWidth = 51;
	this.text_5.parent = this;
	this.text_5.setTransform(273.9,-197);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#006699").ss(2,1,1).p("EAwGggRIAAEYMhbugABEAwGgb5MAAAA8REgwBAgYMBgFAAAEgwFgdRMAAAA9pEgroggXMBbuAAA");
	this.shape.setTransform(-6.2,6.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EAwEAgYMhgFAAAIgEAAIAAgBMAAAg9oIEdAAIAAjGMBbuAAAIAAAGIAAEYMhbugABMBbuAABMAAAA8Rg");
	this.shape_1.setTransform(-6.2,6.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(173,221,230,0.8)").s().p("EhK7Ar1MAAAhXpMCV3AAAMAAABXpgEgxDAhZIAAABIAEAAMBgFAAAIACAAMAAAg8RIAAkYIAAgGIAAgIMhgLAAAIAAABIEdAAIAAAHIAADGIkdAAg");
...
(lib.skiBoyMC = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(0.2,0,1.46,1.46,0.3,0,0,146.6,160.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(148).to({_off:false},0).wait(1).to({regX:162.9,regY:171.9,x:38.8,y:30.9},0).wait(1).to({x:53.7,y:44.7},0).wait(1).to({x:68.6,y:58.5},0).wait(1).to({x:83.5,y:72.4},0).wait(1).to({x:98.5,y:86.2},0).wait(1).to({x:113.3,y:100},0).wait(1).to({x:128.3,y:113.8},0).wait(1).to({x:143.2,y:127.6},0).wait(1).to({x:158.1,y:141.5},0).wait(1).to({x:173,y:155.3},0).wait(1).to({x:187.9,y:169.1},0).wait(1).to({x:198.5,y:176.3},0).wait(1).to({x:209.1,y:183.6},0).wait(1).to({x:219.6,y:190.8},0).wait(1).to({x:230.2,y:198.1},0).wait(1).to({x:240.8,y:205.3},0).wait(1).to({x:251.3,y:212.6},0).wait(1).to({x:261.9,y:219.8},0).wait(1).to({x:272.5,y:227.1},0).wait(1).to({x:283.1,y:234.3},0).wait(1).to({x:293.6,y:241.6},0).wait(1).to({x:304.2,y:248.8},0).wait(1).to({x:314.8,y:256},0).wait(1).to({x:324.3,y:258.2},0).wait(1).to({x:333.9,y:260.4},0).wait(1).to({x:343.4,y:262.5},0).wait(1).to({x:353,y:264.7},0).wait(1).to({x:362.5,y:266.9},0).wait(1).to({x:372,y:269.1},0).wait(1).to({x:381.6,y:271.2},0).wait(1).to({x:391.1,y:273.4},0).wait(1).to({x:400.7,y:275.6},0).wait(1).to({x:410.2,y:277.8},0).wait(1).to({x:419.8,y:279.9},0).wait(1).to({x:429.3,y:279.4},0).wait(1).to({x:438.8,y:278.9},0).wait(1).to({x:448.3,y:278.4},0).wait(1).to({x:457.8,y:277.9},0).wait(1).to({x:467.3,y:277.3},0).wait(1).to({x:476.9,y:276.8},0).wait(1).to({x:486.4,y:276.3},0).wait(1).to({x:495.9,y:275.8},0).wait(1).to({x:505.4,y:275.2},0).wait(1).to({x:514.9,y:274.7},0).wait(1).to({x:524.5,y:274.2},0).wait(1).to({x:531.8,y:273.5},0).wait(1).to({x:539.2,y:272.8},0).wait(1).to({x:546.6,y:272.2},0).wait(1).to({x:554,y:271.5},0).wait(1).to({x:561.4,y:270.8},0).wait(1).to({x:568.8,y:270.1},0).wait(1).to({x:576.2,y:269.5},0).wait(1).to({x:583.5,y:268.8},0).wait(1).to({x:590.9,y:268.1},0).wait(1).to({x:598.3,y:267.4},0).wait(1).to({x:607.5,y:265.4},0).wait(1).to({x:616.7,y:263.3},0).wait(1).to({x:625.9,y:261.3},0).wait(1).to({x:635.1,y:259.2},0).wait(1).to({x:644.2,y:257.2},0).wait(1).to({x:653.4,y:255.1},0).wait(1).to({x:662.6,y:253.1},0).wait(1).to({x:671.8,y:251},0).wait(1));
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(-0.2,0.3,1.46,1.46,0.3,0,0,152.3,159);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(45).to({_off:false},0).wait(1).to({regX:162.9,regY:171.9,rotation:-7.7,x:21.4,y:10.9},0).wait(1).to({rotation:-15.7,x:27.3,y:2.3},0).wait(1).to({rotation:-23.7,x:32.8,y:-6.7},0).wait(1).to({rotation:-31.7,x:37.9,y:-15.8},0).wait(1).to({rotation:-39.7,x:42.6,y:-25.1},0).wait(1).to({rotation:-47.7,x:46.7,y:-34.5},0).wait(1).to({rotation:-55.7,x:50.5,y:-43.9},0).wait(1).to({rotation:-63.7,x:53.7,y:-53.3},0).wait(1).to({rotation:-71.7,x:56.4,y:-62.5},0).wait(1).to({rotation:-79.7,x:58.8,y:-71.7},0).wait(1).to({rotation:-87.7,x:56.2,y:-72.9},0).wait(1).to({rotation:-95.7,x:53.1,y:-73.7},0).wait(1).to({rotation:-103.7,x:49.8,y:-74.3},0).wait(1).to({rotation:-111.7,x:46.2,y:-74.5},0).wait(1).to({rotation:-119.7,x:42.3,y:-74.2},0).wait(1).to({rotation:-127.7,x:38.2,y:-73.6},0).wait(1).to({rotation:-135.7,x:34.1,y:-72.4},0).wait(1).to({rotation:-143.7,x:29.9,y:-70.8},0).wait(1).to({rotation:-151.7,x:25.7,y:-68.7},0).wait(1).to({rotation:-159.7,x:21.7,y:-66.2},0).wait(1).to({rotation:-167.7,x:17.8,y:-63.2},0).wait(1).to({rotation:-175.7,x:14,y:-59.7},0).wait(1).to({rotation:-183.7,x:10.6,y:-56},0).wait(1).to({rotation:-191.7,x:7.5,y:-51.8},0).wait(1).to({rotation:-199.7,x:4.8,y:-47.3},0).wait(1).to({rotation:-207.7,x:2.5,y:-42.6},0).wait(1).to({rotation:-215.7,x:0.6,y:-37.8},0).wait(1).to({rotation:-223.7,x:-0.9,y:-32.7},0).wait(1).to({rotation:-231.7,x:-1.8,y:-27.7},0).wait(1).to({rotation:-239.7,x:-2.4,y:-22.6},0).wait(1).to({rotation:-247.7,y:-17.6},0).wait(1).to({rotation:-255.7,x:-2,y:-12.8},0).wait(1).to({rotation:-263.7,x:-1.1,y:-8.2},0).wait(1).to({rotation:-271.7,x:0.1,y:-3.8},0).wait(1).to({rotation:-279.7,x:1.8,y:0.3},0).wait(1).to({rotation:-287.7,x:3.7,y:4},0).wait(1).to({rotation:-295.7,x:5.8,y:7.3},0).wait(1).to({rotation:-303.7,x:8.2,y:10.2},0).wait(1).to({rotation:-311.7,x:10.8,y:12.6},0).wait(1).to({rotation:-319.7,x:13.4,y:14.6},0).wait(1).to({rotation:-327.7,x:16,y:16.1},0).wait(1).to({rotation:-335.7,x:18.5,y:17.1},0).wait(1).to({rotation:-343.7,x:20.9,y:17.7},0).wait(1).to({rotation:-351.7,x:23.2,y:17.8},0).wait(1).to({rotation:-359.7,x:25.2,y:17.5},0).to({_off:true},1).wait(121));

	// sway
	this.instance_8 = new lib.Symbol1copy();
	this.instance_8.parent = this;
	this.instance_8.setTransform(0.1,-0.1,1.46,1.46,0.5,0,0,154.3,164.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({regX:162.9,regY:171.9,rotation:0.7,x:12.5,y:10.7},0).wait(2).to({rotation:1.3,x:12.4,y:10.9},0).wait(1).to({rotation:1.9,x:12.3,y:11},0).wait(1).to({rotation:2.5,x:12.1,y:11.2},0).wait(1).to({rotation:3.1,y:11.3},0).wait(1).to({rotation:3.7,x:11.9,y:11.4},0).wait(1).to({rotation:4.3,x:11.8,y:11.5},0).wait(1).to({rotation:5,x:11.7,y:11.7},0).wait(1).to({rotation:5.7,x:11.5,y:11.8},0).wait(1).to({rotation:6.4,x:11.4,y:12},0).wait(1).to({rotation:7.1,x:11.3,y:12.1},0).wait(1).to({rotation:7.9,x:11.1,y:12.2},0).wait(1).to({rotation:8.6,x:10.9,y:12.4},0).wait(1).to({rotation:8.1,x:11,y:12.3},0).wait(1).to({rotation:7.6,x:11.1,y:12.2},0).wait(1).to({rotation:7.1,x:11.3,y:12.1},0).wait(1).to({rotation:6.6,y:12},0).wait(1).to({rotation:6.2,x:11.4,y:11.9},0).wait(1).to({rotation:5.7,x:11.5,y:11.8},0).wait(1).to({rotation:5.2,x:11.6,y:11.7},0).wait(1).to({rotation:4.7,x:11.8,y:11.6},0).wait(1).to({rotation:4.1,x:11.9,y:11.5},0).wait(1).to({rotation:3.5,x:12,y:11.3},0).wait(1).to({rotation:2.9,x:12.1,y:11.2},0).wait(1).to({rotation:2.3,x:12.2,y:11.1},0).wait(1).to({rotation:1.7,x:12.3,y:10.9},0).wait(1).to({rotation:1,x:12.4},0).wait(1).to({rotation:0.4,x:12.6,y:10.7},0).to({_off:true},1).wait(182));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-69.8,-76,164.8,173.6);


// stage content:
(lib.SkiYeda = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_0 = function() {
		init(); //פונקציה להוספת סאונד
		var selfHome = this;
		...
		var gameNum = 0; //מספר המשחק, נגזר מהתא הראשון במערך, כאשר התא הראשון (0) הוא פירות והשני (1) הוא יונקים
		...
		var items = [
			[
				[1, lib.fruit0, "תות", 1, 0, 0],
				[1, lib.fruit1, "תפוח", 1, 0, 0],
				[1, lib.fruit2, "לימון", 1, 0, 0],
				[1, lib.fruit3, "אבטיח", 1, 0, 0],
				[1, lib.fruit4, "פטל", 1, 0, 0],
				[1, lib.fruit5, "בננה", 1, 0, 0],
				[0, "משמש", "משמש", 1, 0, 0],
				[0, "תפוז", "תפוז", 1, 0, 0],
				[0, "אגס", "אגס", 1, 0, 0],
				[0, "מלון", "מלון", 1, 0, 0],
				[1, lib.notfruit0, "מלפפון", 0, 0, 0],
				[1, lib.notfruit1, "חציל", 0, 0, 0],
				[1, lib.notfruit2, "גזר", 0, 0, 0],
				[0, "בצל", "בצל", 0, 0, 0],
				[0, "קישוא", "קישוא", 0, 0, 0],
			],
			[
				[1, lib.mammal0, "עטלף", 1, 0, 0],
				[1, lib.mammal1, "חתול", 1, 0, 0],
				[1, lib.mammal2, "כלב", 1, 0, 0],
				[1, lib.mammal3, "שועל", 1, 0, 0],
				[1, lib.mammal4, "חזיר", 1, 0, 0],
				[1, lib.mammal5, "כבשה", 1, 0, 0],
				[0, "קוף", "קוף", 1, 0, 0],
				[0, "נמר", "נמר", 1, 0, 0],
				[0, "פיל", "פיל", 1, 0, 0],
				[0, "דולפין", "דולפין", 1, 0, 0],
				[1, lib.notmammal0, "פרפר", 0, 0, 0],
				[1, lib.notmammal1, "דג", 0, 0, 0],
				[1, lib.notmammal2, "ינשוף", 0, 0, 0]
				[0, "נחש", "נחש", 0, 0, 0],
				[0, "צפרדע", "צפרדע", 0, 0, 0]
			]
		];
		...
		var direction = -5; //משתנה עזר לכיוון התנועה של הרמפה
		var boyMove = 4; //משתנה עזר לתנועה של הגולש
		var myRamp; //יצירת משתנה גלובלי לרמפה
		var boy; //יצירת משתנה גלובלי לילד הגולש
		var myInterval; //משתנה ליצירת אינטרוול, המכיל טיימר ואינטרסקט
		...
		var itemsLocations = [ //מערך למיקומי הפריטים במסך המשוב המאבחן בסיום המשחק
			//פריטים נכונים
			//מיקומי תמונות
			[827, 316, 845, 290],
			[732, 316, 750, 290],
		...
		function runFunc() {
			...
			about_btn.addEventListener("click", aboutFunc); // מאזין ללחיצה, מפעיל פונקציה שמעלה את דף אודות
			...
			function mycb_change(evt) {
				...
				if (mychoice == 0) {
					...
					//אם בחר משחק שני, נאפשר לחיצה ונגדיר משתנה 'מספר משחק'=1=יונקים
					forcombo.startbtn.alpha = 1;
					gameNum = 1;
					forcombo.startbtn.addEventListener("click", startGame); //קריאה לפונקציה שמתחילה משחק
					startbtnClicked = true; // משתנה שמגדיר שכבר התחיל משחק, לכן אם המשתמש פותח את דף "אודות" וסוגר אותו הקומבו-בוקס לא תופיע שוב
		...
		function startGame() {
			...
			//פונקציה אנונימית שרצה בכל שנייה וסופרת זמן, ובנוסף מכילה את האינטרסקט
			myInterval = setInterval(function () {
		
				if (boy.y < myRamp.y) { //רק אם הגולש נמצא בקו של הרמפה נבדוק פגיעה
					if (intersect(boy, myRamp) && items[gameNum][selected][3] == 1 && hit == false) //פונקציה המגדירה מה קורה במקרה של זיהוי נכון של רמפה
					{
						boy.gotoAndPlay(45); //הפעלת אנימציית הסלטה של הגולש
						...
						for (i = 0; i <= gameCorrectAns; i++) { //לולאה הבודקת כמה תשובות נכונות יש לשחקן ומעלה את בר ההתקדמות בהתאם
					...
					if (intersect(boy, myRamp) && items[gameNum][selected][3] == 0 && hit == false) { //פונקציה המגדירה מה קורה במקרה של מעבר דרך רמפה שגויה
						hit = true; //כאשר המשתנה הוא "אמת" לא ניתן לבצע פגיעה - מונע מהגולש לפגוע ברמפה בלופים
						boy.gotoAndPlay(100); //הפעלת אנימצייה של הגולש עצוב
				...
				seconds++; //הוספת 1 שניות לטיימר בכל שניה
				if (seconds == 60) {
					seconds = 0;
					minutes++; //הוספה דקה אחת לטיימר לאחר כל 60 שניות
				}
			}, 1000);
		}
		...
		function createRamp() {
			...
			if (playerCorrectAns < gameCorrectAns) { //הרמפה תוגרל רק במידה ועדיין קיימים פריטים שלא זוהו
				if (items[gameNum][selected][5] == 0 && lastRnd != items[gameNum][selected][1]) { //בדיקה שהאובייקט שהוגרל טרם נענה נכונה, ולא זהה לאוביקט האחרון שהוגרל לפניו
					if (items[gameNum][selected][0] == 0) {
						...
						lastRnd = items[gameNum][selected][1]; //עדכון הפריט בתור הפריט האחרון שהוגרל
		...
		function tick() {
			...
			if (createjs.Ticker.paused == false) {
				myRamp.x += direction; //הרמפה זזה
			}
		
			//במידה ויוצאים מגבולות הבמה, להפעיל מחדש את הפונקציה שמגרילה רמפה
			if (myRamp.x < -200) {
		
				//אם הרמפה שזה עתה יצא מהבמה שייכת לפריט נכון שטרם זוהה, מספר השגיאות עולה
				if (items[gameNum][selected][3] == 1 && items[gameNum][selected][5] == 0) {
					falseAns++
				}
		
				stage.removeChild(stage.getChildByName("ramp")); //מחיקת הרמפה שיצאה מהמסך
				createRamp(); //יצירת רמפה חדשה
			}
		}
		
		// הוספת הילד הגולש לבמה 
		function createBoy() {
			boy = new lib.skiBoyMC();
		...
		function handlekeypress(e) {
			...
			if (e.keyCode == 38 && boy.y >= 140) { //הגדרת גבול
				boy.y -= boyMove;
			}
			//לחיצה על למעלה - הגולש יעלה
			if (e.keyCode == 40 && boy.y <= 470) { //הגדרת גבול
				boy.y += boyMove;
			}
		}
		...
		function PauseFunc() {
			...
			clearInterval(myInterval); //הפסקת האינטרוול של הזמן כדי שהטיימר יעצור
		...
		function continueGameFunc() {
			...
			myInterval = setInterval(function () { //הפעלה מחדש של אינטרוול הטיימר
		...
		//אינטרסקט, מקרה של מפגש בין הגולש והרמפה
		...
		function resultsFunc() { //פונקציה להצגת המשוב המסכם והמאבחן
			...
			showItems(); //קריאה לפונקציה שתייבא את הפריטים
		}
		
		
		function showItems() { //פונקציה המייבאת את הפריטים מהמערך אל דף המשוב
		
			if (gameNum == 0) { //הוספת הפריטים השגויים
		
				var notFruits = new lib.notFruits();
				stage.addChildAt(notFruits, 7);
				notFruits.x = 480;
				notFruits.y = 305;
				notFruits.name = "notFruits";
		
			} else {
		
				var notMammals = new lib.notMammals();
				stage.addChildAt(notMammals, 7);
				notMammals.x = 480;
				notMammals.y = 305;
				notMammals.name = "notMammals";
		
			}
		
			for (i = 0; i < items[gameNum].length; i++) { //מערך להצבת האובייקטים בדף המשוב
		
				if (items[gameNum][i][3] == 1) { //תנאי שבודק אם הפריט נכון
		
					if (items[gameNum][i][0] == 1) { //תנאי שבודק אם הפריט הוא תמונה
						var trueItem = new(items[gameNum][i][1])(); //הוספת התמונה על פי פרטיה במערך
						trueItem.x = itemsLocations[i][0]; //מיקום התמונה על ציר ה-X
						trueItem.y = itemsLocations[i][1]; //מיקום התמונה על ציר ה-Y
						trueItem.name = "trueItem" [i]; //מתן שם לתמונה
						stage.addChildAt(trueItem, 7); //הצבת התמונה על הבמה
		
		
						if (items[gameNum][i][4] > 1) { //בדיקה האם הפריט הופיע יותר מפעם אחת - אם כן, תופיע כוכבית
							var star = new createjs.Text();
							star.x = itemsLocations[i][2];
							star.y = itemsLocations[i][3];
							star.color = "#CC0000";
							star.font = "25px Arial";
							star.text = "*";
							star.name = "star" [i];
							stage.addChildAt(star, 7);
						}
		
					} else { //אם הפריט הוא טקסט
						var trueTextItem = new createjs.Text();
						trueTextItem.x = itemsLocations[i][0];
						trueTextItem.y = itemsLocations[i][1];
						trueTextItem.color = "#0F4250";
						trueTextItem.font = "20px Arial";
						trueTextItem.text = items[gameNum][i][1];
						trueTextItem.name = "trueTextItem" [i];
						stage.addChildAt(trueTextItem, 7);
		
						if (items[gameNum][i][4] > 1) { //בדיקה האם הפריט הופיע יותר מפעם אחת - אם כן, תופיע כוכבית
							var textStar = new createjs.Text();
							textStar.x = itemsLocations[i][2];
							textStar.y = itemsLocations[i][3];
							textStar.color = "#CC0000";
							textStar.font = "25px Arial";
							textStar.text = "*";
							textStar.name = "textStar" [i];
							stage.addChildAt(textStar, 7);
						}
		...
		function playAgain() { //פונקציה שמפעילה את אותו המשחק פעם נוספת
			...
			for (i = 0; i < items[gameNum].length; i++) { //לולאה למחיקת הפריטים מדף המשוב
				stage.removeChild(stage.getChildByName("trueItem" [i]));
				stage.removeChild(stage.getChildByName("star" [i]));
				stage.removeChild(stage.getChildByName("trueTextItem" [i]));
				stage.removeChild(stage.getChildByName("textStar" [i]));
				stage.removeChild(stage.getChildByName("notFruits"));
				stage.removeChild(stage.getChildByName("notMammals"));
			}
	...
	// Actions
	this.myCSS = new lib.an_CSS({'id': 'myCSS', 'href':'assets/CSS.css'});

	this.myCSS.setTransform(543.3,-98.2,1,1,0,0,0,48.5,17.7);

	this.timeline.addTween(cjs.Tween.get(this.myCSS).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(444.4,178.6,630.9,134.6);
// library properties:
lib.properties = {
	id: '7E1DFBDBFC0FFF428956F5DCF7B007C1',
	width: 960,
	height: 590,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Ski_Yeda_atlas_.png?1518352120048", id:"Ski_Yeda_atlas_"},
		{src:"sounds/end.mp3?1518352120214", id:"end"},
		{src:"sounds/_false.mp3?1518352120214", id:"_false"},
		{src:"sounds/_true.mp3?1518352120214", id:"_true"},
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1518352120214", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1518352120214", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1518352120214", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1518352120214", id:"an.ComboBox"}
	],
	preloads: []
};
...
an.compositions['7E1DFBDBFC0FFF428956F5DCF7B007C1'] = {
